...
class RecipeListAdapter(private val recipeList: Array<Recipe>) :
    ...
    inner class RecipeViewHolder(itemView: View) : RecyclerView.ViewHolder(
        ...
        val name_text: TextView = itemView.findViewById(R.id.name_text_view)
        val description_text: TextView = itemView.findViewById(R.id.description_text_view)
        ...
        override fun onClick(view: View?) {
            ...
            if (view != null) {
                val intent = Intent(view.context, RecipeActivity::class.java).apply {
                    ...
                    putExtra("context", recipe.context)
                }
    ...
    override fun onBindViewHolder(holder: RecipeViewHolder, position: Int) {
        holder.name_text.text = recipeList[position].name
        holder.description_text.text = recipeList[position].description
    }
